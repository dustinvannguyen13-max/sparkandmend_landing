...
export const pricingNotes = [
  ...
  "Prices are generated by the same calculator used in the booking form.",
  "Your exact price may change with property size, frequency, and add-ons.",
];

export const pricingCtas = [
  { label: "Arrange Regular Cleaning", href: "/get-a-quote?service=basic" },
  { label: "Arrange Deep Cleaning", href: "/get-a-quote?service=intermediate" },
  { label: "Arrange End of Tenancy", href: "/get-a-quote?service=advanced" },
  { label: "Arrange Commercial", href: "/get-a-quote?service=commercial" },
];
