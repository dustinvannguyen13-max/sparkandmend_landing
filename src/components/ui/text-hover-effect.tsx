                ...
                >
                    {hovered && (
                        <>
                            ...
                            <stop offset="25%" stopColor={"hsl(var(--brand-light))"} />
                            <stop offset="50%" stopColor={"hsl(var(--brand-dark))"} />
                            <stop offset="75%" stopColor={"hsl(var(--brand-light))"} />
                            <stop offset="100%" stopColor={"hsl(var(--brand-dark))"} />
                        </>
                    )}
                </linearGradient>
