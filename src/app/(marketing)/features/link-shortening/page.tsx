            ...
            <MaxWidthWrapper>
                <AnimationContainer delay={0.1} className="w-full">
                    <div className="flex flex-col items-center justify-center py-10 max-w-xl mx-auto">
                        <MagicBadge title="Basic Clean" />
                        <h1 className="text-2xl md:text-4xl lg:text-5xl font-semibold font-heading text-center mt-6 !leading-tight">
                            Regular cleaning for a fresh, tidy space
                        </h1>
                        <p className="text-base md:text-lg mt-6 text-center text-muted-foreground">
                            Perfect for regular upkeep and maintaining a fresh, tidy space. Ideal for weekly or bi-weekly cleans for homes and small offices.
                        </p>
                    ...
                    <LampContainer className="max-w-2xl mx-auto">
                        <div className="flex flex-col items-center justify-center relative w-full text-center">
                            <h2 className="bg-gradient-to-br from-[#efe6d9] to-[#714b4b] py-4 bg-clip-text text-center text-4xl font-semibold font-heading tracking-tight text-transparent md:text-7xl mt-8">
                                Keep your space consistently clean
                            </h2>
                            <p className="text-muted-foreground mt-6 max-w-lg mx-auto text-base md:text-lg">
                                Book regular visits and enjoy a fresh, tidy home or office every week.
                            </p>
                            <div className="mt-6">
                                <Button asChild>
