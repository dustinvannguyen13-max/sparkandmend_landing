...
const DESCRIPTION =
  "Cleaning prices in Plymouth are calculated instantly with our quote calculator. Pricing depends on property size, service level, frequency, and add-ons.";
          ...
          <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div className="text-center lg:text-left">
              <SectionHeader
                ...
                description="Get transparent pricing generated by our instant quote calculator. Prices update with your service level, home size, and schedule."
                align="left"
              />
      ...
      <Section id="price-ranges" className={`${sectionBase} ${surfacePrimary}`}>
        <AnimationContainer delay={0.2}>
          <SectionHeader
            ...
            description="These ranges are generated from the same calculator used in the quote form. They assume no add-ons and typical layouts."
          />
      ...
      <Section className={`${sectionBase} ${surfaceMuted}`}>
        <AnimationContainer delay={0.35}>
          <SectionHeader
            ...
            title="Get an exact price instantly"
      ...
      <Section>
        <div className="flex flex-col items-center gap-4 rounded-3xl border border-border/70 bg-card/90 px-6 py-10 text-center shadow-[0_30px_70px_-50px_hsl(var(--primary)/0.5)] md:px-12 md:py-12">
          ...
          <p className="text-base md:text-lg text-muted-foreground">
            Use the calculator to lock in a fixed instant quote and book your
            Plymouth clean.
          </p>
